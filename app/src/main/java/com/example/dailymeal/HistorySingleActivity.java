...
public class HistorySingleActivity extends AppCompatActivity implements OnMapReadyCallback, RoutingListener {
    private String rideId, currentUserId, customerId, driverId, userDeliverypersonOrCustomer;
    ...
    */
        ...
        rideLocation = (TextView) findViewById(R.id.customerLocation);
                    ...
                    for (DataSnapshot child:dataSnapshot.getChildren()){
                        if (child.getKey().equals("customer")){
                            ...
                            if(!customerId.equals(currentUserId)){
                                userDeliverypersonOrCustomer = "deliveryperson";
                                getUserInformation("customer", customerId);
                            }
                        }
                        if (child.getKey().equals("deliveryperson")){
                            driverId = child.getValue().toString();
                            if(!driverId.equals(currentUserId)){
                                userDeliverypersonOrCustomer = "customer";
                                getUserInformation("deliveryperson", driverId);
                        ...
                        if (child.getKey().equals("distance")){
                            ...
                            ridePrice = Double.valueOf(distance) * 10;
...
*/
    ...
    public void onRoutingSuccess(ArrayList<Route> route, int shortestRouteIndex) {
        ...
        mMap.addMarker(new MarkerOptions().position(pickupLatLng).title("pickup location").icon(BitmapDescriptorFactory.fromResource(R.mipmap.home)));
